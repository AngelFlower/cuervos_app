import 'package:cuervos_app/core/env/env.dart';
...
class CalendarioEscolar {
  Future<String> obtenerCalendario() async {
    ...
    if (peticion != 'Error al obtener el calendario') {
      peticion = '${Env.proxyUrl}https://utvt.edomex.gob.mx$peticion';
    }
    // print(peticion);
    return peticion;
  }
  ...
  Future<String> _peticionCalendario() async {
    String retorno = '';
    await http.get(Uri.parse('${Env.proxyUrl}https://utvt.edomex.gob.mx/calendario-escolar')).then((response) {
