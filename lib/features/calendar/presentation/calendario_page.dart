            ...
            return Scaffold(
                ...
                floatingActionButton: FloatingActionButton(
                  ...
                  onPressed: () async {
                    ...
                    await Share.shareXFiles([XFile(path)], text: 'Imagen del calendario escolar');
                  },
  ...
  AppBar getAppBarCalendar(BuildContext context) {
    return AppBar(
      ...
      title: Column(
        ...
        children: [
          const Text('Calendario Escolar', style: TextStyle(fontWeight: FontWeight.w400)),
          Text(
            'Puedes utilizar gestos',
            style: TextStyle(fontSize: 14, color: Colors.grey.shade100, fontWeight: FontWeight.w400),
          ),
        ],
      ),
    );
