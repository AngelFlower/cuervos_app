...
class _GradesPageState extends State<GradesPage> {
            ...
            if (snapshot.hasData) {
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  var longitud = snapshot.data['estudiante']['cuatrimestres'].length;

                  materias = snapshot.data['estudiante']['cuatrimestres'][(longitud - index).toString()]['materias'];
                  ...
                  return _cardCuatrimestre(expanded, snapshot, longitud, index, calificacionesWidgets);
                },
              );
            } else {
              return const Center(
  ...
  Card _cardCuatrimestre(
      bool expanded, AsyncSnapshot<dynamic> snapshot, longitud, int index, List<Widget> calificacionesWidgets) {
    return Card(
      child: Padding(
        ...
        child: Theme(
          ...
          child: ExpansionTile(
            ...
            title: Text('${snapshot.data['estudiante']['cuatrimestres'][(longitud - (index)).toString()]['nombre']}',
